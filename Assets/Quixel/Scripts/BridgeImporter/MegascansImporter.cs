        ...
        public string ImportMegascansAssets(JObject objectList)
        {
            ...
            if (meshComps.Count > 0)
            {
                ...
                try {
                    ...
                    PrefabData prefData = new PrefabData(path, finalName, lodFadeMode, highPoly, addAssetToScene, setupCollision, hasBillboardLOD, isAlembic, false, false, finalMat, hpMat, billboardMat, new List<string>(), new List<List<string>>());
